    ...
    <div className="flex flex-col items-center w-full">
      <div
        className={clsx(
          pathname === "/"
            ? " bg-[#FAFAFA]"
            : "max-w-6xl bg-accent-1 border-b border-neutral-200",
          "flex flex-col md:flex-row items-start md:items-center justify-between w-full px-10 md:px-[195px] py-10 gap-y-5 md:gap-y-0",
        )}
      >
      ...
      <div className="flex flex-col md:flex-row items-start justify-start md:justify-center w-full px-10 md:px-[195px] py-[25px] gap-x-0 md:gap-x-3 gap-y-10 md:gap-y-0">
        <div className="flex flex-col items-start w-full gap-y-3">
          ...
          <div className="flex flex-col items-start w-full gap-y-1">
            <Link href="/" className="font-semibold text-[14px] text-neutral-500 hover:underline">
              About Us
            </Link>
            <Link href="/" className="font-semibold text-[14px] text-neutral-500 hover:underline">
              Carrier
        ...
        <div className="flex flex-col items-start w-full gap-y-3">
          ...
          <div className="flex flex-col items-start w-full gap-y-1">
            <div className="flex flex-row items-center w-full overflow-hidden rounded-xl border border-neutral-200">
              <input
                type="text"
            ...
            <p className="font-normal text-[12px] text-neutral-500">Lore imp sum dolor Amit</p>
          </div>
        </div>
      </div>
