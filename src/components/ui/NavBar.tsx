...
import WishlistMenu from "./menus/WishlistMenu";
...
export default function NavBar(): JSX.Element {
  ...
  return (
    <nav className="flex flex-col w-full">
      <div className="hidden md:flex flex-col items-center w-full px-3 text-white bg-accent-3">
        <div className="flex flex-row items-center justify-between w-full max-w-6xl py-3">
      ...
      <div className="flex flex-col items-center w-full p-5 md:p-3 text-accent-2 bg-accent-1">
        <div className="flex flex-row items-center justify-between w-full max-w-full md:max-w-6xl py-3">
          <div className="flex flex-col md:flex-row items-center w-full gap-x-5 md:gap-x-[10rem] gap-y-10 md:gap-y-0">
            <div className="flex flex-row items-center justify-between w-full">
              <Logo />
              <div className="flex md:hidden flex-row items-center justify-end gap-x-5">
                <button type="button" aria-label="Search">
                  <svg
                    className="w-5 h-5 fill-current text-accent-2"
                    viewBox="0 0 16 16"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <CartMenu
                  className="flex flex-row items-center gap-x-1 text-accent-2 outline-none"
                ...
                <WishlistMenu
                  ...
                  iconClassName="w-5 h-5 fill-current"
                />
                <button type="button" aria-label="Menu" onClick={() => setIsShowMenu(!isShowMenu)}>
                  <svg
                    className="w-5 h-5 fill-current text-accent-2"
                    width="24"
                    height="14"
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M0.571472 0H23.4286V2.28571H0.571472V0ZM6.28576 5.71429H23.4286V8H6.28576V5.71429ZM13.4286 11.4286H23.4286V13.7143H13.4286V11.4286Z" />
                  </svg>
                </button>
              </div>
            </div>
            <ul
              className={clsx(
                ...
                "flex-col md:flex-row items-center justify-center gap-x-0 md:gap-x-5 gap-y-10 md:gap-y-0",
              )}
            >
              <li>
                <Link
                  className="font-semibold text-[30px] md:text-[14px] leading-[0.2px] text-neutral-500"
                  href="/"
          ...
          <div className="hidden md:flex flex-row items-center justify-end w-full gap-x-5">
            <Link
              href="/"
